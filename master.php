...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-list"></i>Forms</a>
  ...
  <li><a href="supplier"><i class="icon icon-user"></i> <span>Users</span></a> </li>
  <li><a href="#"><i class="icon icon-shopping-cart"></i> <span>Barang</span></a> </li>
  <li><a href="supplier"><i class="icon icon-truck"></i> <span>Supplier</span></a> </li>
  </ul>
</div>
<?php include "isi.php";?>
<!--Footer-part-->
<div class="row-fluid">
  <div id="footer" class="span12"> 2017 &copy; <a href="http://computerbanten.blogspot.co.id">Firhan Adnan & Team</a> </div>
</div>
<!--end-Footer-part-->
