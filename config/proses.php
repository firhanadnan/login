...
// ############################################ END MODULE USER ############################################################
// ## USER-SUPPLIER
elseif($page == "input-supplier"){
$supplier->input_supplier($_POST['kode_supplier'],$_POST['nama_supplier'],$_POST['alamat']);
  header("location:../supplier");
}

// ## USER-UPDATE
elseif($page == "update-supplier"){
$supplier->update_supplier($_POST['kode_supplier'],$_POST['nama_supplier'],$_POST['alamat']);
  header("location:../supplier");
}
// ## USER-DELETE
elseif($page == "hapus-supplier"){
$supplier->hapus_supplier($_GET['kode_supplier']);
  header("location:../supplier");
}
