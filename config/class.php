...
class Supplier {
	...
	// proses input data user
	function input_supplier($kode_supplier,$nama_supplier,$alamat){
		mysql_query("INSERT INTO supplier (kode_supplier,nama_supplier,alamat) VALUES ('$kode_supplier','$nama_supplier','$alamat')");
	}

	// tampilkan data dari tabel suppliers yang akan di edit 
	function edit_supplier($kode_supplier){
		$data=mysql_query("SELECT * FROM supplier WHERE kode_supplier='$kode_supplier'");
		while($x=mysql_fetch_array($data)){
			$hasil[]=$x;
		}
		return $hasil;
	...
	function update_supplier($kode_supplier,$nama_supplier,$alamat){
		mysql_query("UPDATE supplier SET nama_supplier='$nama_supplier',alamat='$alamat' WHERE kode_supplier='$kode_supplier'");
	}

	// proses delete data supplier
	function hapus_supplier($kode_supplier){
		mysql_query("DELETE FROM supplier where kode_supplier='$kode_supplier'");
	}
}
